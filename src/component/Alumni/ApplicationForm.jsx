...
import { db, collection, setDoc, getDoc, doc, auth } from "../../firebase/firebase";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (docSnap.exists()) {
         ...
         setSubmitted(true);
         navigate(`/:userEmail/${sanitizedEmail}`);
       }
    } catch (error) {
    ...
    <div className="bg-gray-100 min-h-screen p-10 pt-25 flex flex-col items-center">
      ...
      {submitted ? (
        ...
        <form className="bg-white p-6 rounded-lg shadow-md w-full max-w-md" >
          ...
          <button onClick={handleSubmit} type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-semibold mt-4 cursor-pointerb" disabled={loading}>
